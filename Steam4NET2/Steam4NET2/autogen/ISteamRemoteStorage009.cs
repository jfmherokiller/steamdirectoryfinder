...
namespace Steam4Net
{
    ...
    public class SteamRemoteStorage009VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("STEAMREMOTESTORAGE_INTERFACE_VERSION009")]
    public class SteamRemoteStorage009 : InteropHelp.NativeWrapper<SteamRemoteStorage009VTable>
    {
        ...
        {
            return GetFunction<NativeUgcDownloadU>(Functions.UGCDownload21)(ObjectAddress, hContent);
        }
