...
namespace Steam4Net
{
    ...
    public class SteamUtils003VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("SteamUtils003")]
    public class SteamUtils003 : InteropHelp.NativeWrapper<SteamUtils003VTable>
    {
