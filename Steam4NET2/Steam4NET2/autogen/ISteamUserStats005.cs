...
namespace Steam4Net
{
    ...
    public class SteamUserStats005VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("STEAMUSERSTATS_INTERFACE_VERSION005")]
    public class SteamUserStats005 : InteropHelp.NativeWrapper<SteamUserStats005VTable>
    {
        ...
        public ulong UploadLeaderboardScore(ulong hSteamLeaderboard, int nScore, ref int pScoreDetails,
            int cScoreDetailsCount)
        {
            return GetFunction<NativeUploadLeaderboardScoreUiii>(Functions.UploadLeaderboardScore26)(ObjectAddress,
                hSteamLeaderboard, nScore, ref pScoreDetails, cScoreDetailsCount);
        }
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate ulong NativeUploadLeaderboardScoreUiii(
            IntPtr thisptr, ulong hSteamLeaderboard, int nScore, ref int pScoreDetails, int cScoreDetailsCount);
    };
}