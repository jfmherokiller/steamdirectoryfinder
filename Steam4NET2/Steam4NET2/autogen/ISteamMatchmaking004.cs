...
namespace Steam4Net
{
    ...
    public class SteamMatchmaking004VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("SteamMatchMaking004")]
    public class SteamMatchmaking004 : InteropHelp.NativeWrapper<SteamMatchmaking004VTable>
    {
        ...
        {
            return GetFunction<NativeRequestFriendsLobbies>(Functions.RequestFriendsLobbies26)(ObjectAddress);
        }
