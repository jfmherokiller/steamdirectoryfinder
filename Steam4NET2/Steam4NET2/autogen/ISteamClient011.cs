...
namespace Steam4Net
{
    ...
    public class SteamClient011VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("SteamClient011")]
    public class SteamClient011 : InteropHelp.NativeWrapper<SteamClient011VTable>
    {
            ...
            where TClass : InteropHelp.INativeWrapper, new()
        {
            return
                InteropHelp.CastInterface<TClass>(
                    GetFunction<NativeGetISteamScreenshotsIis>(Functions.GetISteamScreenshots19)(ObjectAddress,
                        hSteamuser, hSteamPipe, InterfaceVersions.GetInterfaceIdentifier(typeof(TClass))));
        }

        public void RunFrame()
        {
            GetFunction<NativeRunFrame>(Functions.RunFrame20)(ObjectAddress);
        }

        public uint GetIpcCallCount()
        {
            return GetFunction<NativeGetIpcCallCount>(Functions.GetIPCCallCount21)(ObjectAddress);
        }

        public void SetWarningMessageHook(ref IntPtr pFunction)
        {
            GetFunction<NativeSetWarningMessageHookI>(Functions.SetWarningMessageHook22)(ObjectAddress, ref pFunction);
        }

        public bool BShutdownIfAllPipesClosed()
        {
            return GetFunction<NativeBShutdownIfAllPipesClosed>(Functions.BShutdownIfAllPipesClosed23)(ObjectAddress);
        }
            ...
            where TClass : InteropHelp.INativeWrapper, new()
        {
            return
                InteropHelp.CastInterface<TClass>(
                    GetFunction<NativeGetISteamHttpiis>(Functions.GetISteamHTTP24)(ObjectAddress, hSteamuser, hSteamPipe,
                        InterfaceVersions.GetInterfaceIdentifier(typeof(TClass))));
        }
