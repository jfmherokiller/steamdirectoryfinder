...
namespace Steam4Net
{
    ...
    public class SteamGameServer009VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("SteamGameServer009")]
    public class SteamGameServer009 : InteropHelp.NativeWrapper<SteamGameServer009VTable>
    {
        public void LogOn()
        {
