...
namespace Steam4Net
{
    ...
    public class SteamFriends004VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("SteamFriends004")]
    public class SteamFriends004 : InteropHelp.NativeWrapper<SteamFriends004VTable>
    {
        ...
        public CSteamId GetFriendByIndex(int iFriend, EFriendFlags eFriendFlags)
        {
            ulong ret = 0;
        ...
        private delegate void NativeGetFriendByIndexIe(
            IntPtr thisptr, ref ulong retarg, int iFriend, EFriendFlags eFriendFlags);
