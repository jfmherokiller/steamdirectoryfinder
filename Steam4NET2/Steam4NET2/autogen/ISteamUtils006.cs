...
namespace Steam4Net
{
    ...
    public class SteamUtils006VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("SteamUtils006")]
    public class SteamUtils006 : InteropHelp.NativeWrapper<SteamUtils006VTable>
    {
            ...
            return
                InteropHelp.DecodeAnsiReturn(
                    Marshal.PtrToStringAnsi(
                        GetFunction<NativeGetSteamUiLanguage>(Functions.GetSteamUILanguage23)(ObjectAddress)));
        }
