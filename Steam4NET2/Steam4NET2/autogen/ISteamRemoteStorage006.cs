...
namespace Steam4Net
{
    ...
    public class SteamRemoteStorage006VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("STEAMREMOTESTORAGE_INTERFACE_VERSION006")]
    public class SteamRemoteStorage006 : InteropHelp.NativeWrapper<SteamRemoteStorage006VTable>
    {
        ...
        public ulong PublishVideo(string cszFileName, string cszPreviewFileName, uint nConsumerAppId, string cszTitle,
            string cszDescription, ERemoteStoragePublishedFileVisibility eVisibility, ref SteamParamStringArrayT pTags)
        {
            return GetFunction<NativePublishVideoSsusses>(Functions.PublishVideo43)(ObjectAddress, cszFileName,
                cszPreviewFileName, nConsumerAppId, cszTitle, cszDescription, eVisibility, ref pTags);
        }
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate ulong NativePublishVideoSsusses(
            IntPtr thisptr, string cszFileName, string cszPreviewFileName, uint nConsumerAppId, string cszTitle,
            string cszDescription, ERemoteStoragePublishedFileVisibility eVisibility, ref SteamParamStringArrayT pTags);
