...
namespace Steam4Net
{
    ...
    [InteropHelp.InterfaceVersionAttribute("Steam003")]
    public class Steam003 : InteropHelp.NativeWrapper<Steam003VTable>
    {
        ...
        public int GetUser(StringBuilder szUser, ref uint puUserChars, ref SteamGlobalUserId pSteamGlobalUserId,
            ref SteamError pError)
        {
            return GetFunction<NativeGetUserSuutt>(Functions.GetUser71)(ObjectAddress, szUser, (uint)szUser.Capacity,
                ref puUserChars, ref pSteamGlobalUserId, ref pError);
        }
        ...
        private delegate int NativeGetUserSuutt(
            ...
            ref SteamGlobalUserId pSteamGlobalUserId, ref SteamError pError);
