...
namespace Steam4Net
{
    ...
    public class SteamMatchmaking003VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("SteamMatchMaking003")]
    public class SteamMatchmaking003 : InteropHelp.NativeWrapper<SteamMatchmaking003VTable>
    {
        ...
        {
            GetFunction<NativeCreateLobbyB>(Functions.CreateLobby9)(ObjectAddress, bPrivate);
        }
        ...
        {
            GetFunction<NativeSetLobbyVoiceEnabledCb>(Functions.SetLobbyVoiceEnabled26)(ObjectAddress,
                steamIdLobby.ConvertToUint64(), bEnabled);
        }
        ...
        private delegate void NativeSetLobbyVoiceEnabledCb(
            IntPtr thisptr, ulong steamIdLobby, [MarshalAs(UnmanagedType.I1)] bool bEnabled);
