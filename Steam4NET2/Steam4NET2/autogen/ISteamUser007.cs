...
namespace Steam4Net
{
    ...
    public class SteamUser007VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("SteamUser007")]
    public class SteamUser007 : InteropHelp.NativeWrapper<SteamUser007VTable>
    {
        ...
        {
            return GetFunction<NativeInitiateGameConnectionBiccuubbi>(Functions.InitiateGameConnection9)(ObjectAddress,
        ...
        {
            GetFunction<NativeRefreshSteam2Login>(Functions.RefreshSteam2Login12)(ObjectAddress);
        }
