...
namespace Steam4Net
{
    ...
    public class SteamRemoteStorage010VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("STEAMREMOTESTORAGE_INTERFACE_VERSION010")]
    public class SteamRemoteStorage010 : InteropHelp.NativeWrapper<SteamRemoteStorage010VTable>
    {
        ...
        public int UgcRead(ulong hContent, byte[] pvData, uint uOffset)
        {
            return GetFunction<NativeUgcReadUbiu>(Functions.UGCRead24)(ObjectAddress, hContent, pvData, pvData.Length,
                uOffset);
        }
        ...
        {
            return GetFunction<NativeGetPublishedFileDetailsU>(Functions.GetPublishedFileDetails36)(ObjectAddress,
                unPublishedFileId);
        }
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate int NativeUgcReadUbiu(
            IntPtr thisptr, ulong hContent, byte[] pvData, int cubDataToRead, uint uOffset);
