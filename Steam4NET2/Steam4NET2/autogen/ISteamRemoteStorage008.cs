...
namespace Steam4Net
{
    ...
    public class SteamRemoteStorage008VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("STEAMREMOTESTORAGE_INTERFACE_VERSION008")]
    public class SteamRemoteStorage008 : InteropHelp.NativeWrapper<SteamRemoteStorage008VTable>
    {
        ...
        {
            return GetFunction<NativeUgcReadUbi>(Functions.UGCRead24)(ObjectAddress, hContent, pvData, pvData.Length);
        }
