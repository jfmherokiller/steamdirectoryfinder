...
namespace Steam4Net
{
    ...
    public class SteamFriends013VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("SteamFriends013")]
    public class SteamFriends013 : InteropHelp.NativeWrapper<SteamFriends013VTable>
    {
        ...
        public ulong SetPersonaName(string pchPersonaName)
        {
            return GetFunction<NativeSetPersonaNameS>(Functions.SetPersonaName1)(ObjectAddress, pchPersonaName);
        }
        ...
        {
            GetFunction<NativeActivateGameOverlayToStoreUe>(Functions.ActivateGameOverlayToStore24)(ObjectAddress,
                nAppId, eFlag);
        }
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate ulong NativeSetPersonaNameS(IntPtr thisptr, string pchPersonaName);
