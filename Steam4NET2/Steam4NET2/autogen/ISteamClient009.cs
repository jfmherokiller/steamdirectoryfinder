...
namespace Steam4Net
{
    ...
    public class SteamClient009VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("SteamClient009")]
    public class SteamClient009 : InteropHelp.NativeWrapper<SteamClient009VTable>
    {
