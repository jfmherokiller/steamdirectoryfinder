...
namespace Steam4Net
{
    ...
    public class SteamUserStats007VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("STEAMUSERSTATS_INTERFACE_VERSION007")]
    public class SteamUserStats007 : InteropHelp.NativeWrapper<SteamUserStats007VTable>
    {
        ...
        {
            return GetFunction<NativeGetNumberOfCurrentPlayers>(Functions.GetNumberOfCurrentPlayers29)(ObjectAddress);
        }
