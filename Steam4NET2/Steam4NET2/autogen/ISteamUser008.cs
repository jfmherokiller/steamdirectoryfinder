...
namespace Steam4Net
{
    ...
    public class SteamUser008VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("SteamUser008")]
    public class SteamUser008 : InteropHelp.NativeWrapper<SteamUser008VTable>
    {
        ...
        {
            return GetFunction<NativeInitiateGameConnectionBiccuubbi>(Functions.InitiateGameConnection3)(ObjectAddress,
                pBlob, pBlob.Length, steamId.ConvertToUint64(), gameId.ConvertToUint64(), unIpServer, usPortServer,
                bSecure, pvSteam2GetEncryptionKey, pvSteam2GetEncryptionKey.Length);
        }
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate int NativeInitiateGameConnectionBiccuubbi(
