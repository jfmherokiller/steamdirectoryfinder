...
namespace Steam4Net
{
    ...
    [InteropHelp.InterfaceVersionAttribute("Steam006")]
    public class Steam006 : InteropHelp.NativeWrapper<Steam006VTable>
    {
        ...
        public uint OpenFileEx(string cszFileName, string cszMode, int nFlags, ref uint puFileSize, ref int pnLocal,
            ref SteamError pError)
        {
            return GetFunction<NativeOpenFileExSsiuit>(Functions.OpenFileEx16)(ObjectAddress, cszFileName, cszMode,
                nFlags, ref puFileSize, ref pnLocal, ref pError);
        }
        ...
        public uint RefreshAccountInfo(int bContentDescriptionOnly, ref SteamError pError)
        {
            return GetFunction<NativeRefreshAccountInfoIt>(Functions.RefreshAccountInfo65)(ObjectAddress,
                bContentDescriptionOnly, ref pError);
        }
        ...
        public int GetLocalClientVersion(ref uint puBootStrapperVersionNum, ref uint puClientAppVersionNum,
            ref SteamError pError)
        {
            return GetFunction<NativeGetLocalClientVersionUut>(Functions.GetLocalClientVersion128)(ObjectAddress,
                ref puBootStrapperVersionNum, ref puClientAppVersionNum, ref pError);
        }

        public int IsFileNeededByCache(uint uCacheId, string cszFileName, uint uFileSize, ref SteamError pError)
        {
            return GetFunction<NativeIsFileNeededByCacheUsut>(Functions.IsFileNeededByCache129)(ObjectAddress, uCacheId,
                cszFileName, uFileSize, ref pError);
        }

        public int LoadFileToCache(uint uCacheId, string pchFileName, byte[] pubDataChunk, uint cubDataOffset,
            ref SteamError pError)
        {
            return GetFunction<NativeLoadFileToCacheUsbuut>(Functions.LoadFileToCache130)(ObjectAddress, uCacheId,
                pchFileName, pubDataChunk, (uint)pubDataChunk.Length, cubDataOffset, ref pError);
        }

        public int GetCacheDecryptionKey(uint uAppId, StringBuilder szCacheDecryptionKey, ref uint puRecievedLength,
            ref SteamError pError)
        {
            return GetFunction<NativeGetCacheDecryptionKeyUsuut>(Functions.GetCacheDecryptionKey131)(ObjectAddress,
                uAppId, szCacheDecryptionKey, (uint)szCacheDecryptionKey.Capacity, ref puRecievedLength, ref pError);
        }

        public int GetSubscriptionExtendedInfo(uint uSubscriptionId, string cszKeyName, StringBuilder szKeyValue,
            ref uint puRecievedLength, ref SteamError pError)
        {
            return
                GetFunction<NativeGetSubscriptionExtendedInfoUssuut>(Functions.GetSubscriptionExtendedInfo132)(
                    ObjectAddress, uSubscriptionId, cszKeyName, szKeyValue, (uint)szKeyValue.Capacity,
                    ref puRecievedLength, ref pError);
        }

        public int GetSubscriptionPurchaseCountry(uint uSubscriptionId, StringBuilder szCountry, ref int pPurchaseTime,
            ref SteamError pError)
        {
            return
                GetFunction<NativeGetSubscriptionPurchaseCountryUsuit>(Functions.GetSubscriptionPurchaseCountry133)(
                    ObjectAddress, uSubscriptionId, szCountry, (uint)szCountry.Capacity, ref pPurchaseTime, ref pError);
        }

        public int GetAppUserDefinedRecord(uint uAppId, ref IntPtr addEntryToKeyValueFunc, byte[] pvCKeyValue,
            ref SteamError pError)
        {
            return GetFunction<NativeGetAppUserDefinedRecordUibt>(Functions.GetAppUserDefinedRecord134)(ObjectAddress,
                uAppId, ref addEntryToKeyValueFunc, pvCKeyValue, ref pError);
        }

        public int FindServersNumServers(ESteamServerType eSteamServerType)
        {
            return GetFunction<NativeFindServersNumServersE>(Functions.FindServersNumServers135)(ObjectAddress,
                eSteamServerType);
        }

        public int FindServersIterateServer(ESteamServerType eSteamServerType, uint uIndex,
            StringBuilder szServerAddress)
        {
            return GetFunction<NativeFindServersIterateServerEusi>(Functions.FindServersIterateServer136)(
                ObjectAddress, eSteamServerType, uIndex, szServerAddress, szServerAddress.Capacity);
        }
            ...
            return
                InteropHelp.DecodeAnsiReturn(
                    Marshal.PtrToStringAnsi(
                        GetFunction<NativeFindServersGetErrorString>(Functions.FindServersGetErrorString137)(
                            ObjectAddress)));
        }

        public int CheckAppOwnership(uint uAppId, ref int pbOwned, ref SteamGlobalUserId pSteamGlobalUserId,
            ref SteamError pError)
        {
            return GetFunction<NativeCheckAppOwnershipUitt>(Functions.CheckAppOwnership138)(ObjectAddress, uAppId,
                ref pbOwned, ref pSteamGlobalUserId, ref pError);
        }

        public uint GetCachePercentFragmentation(uint uAppId, ref uint puPercentFragmented, ref SteamError pError)
        {
            return
                GetFunction<NativeGetCachePercentFragmentationUut>(Functions.GetCachePercentFragmentation139)(
                    ObjectAddress, uAppId, ref puPercentFragmented, ref pError);
        }

        public uint DefragCaches(uint uAppId, ref SteamError pError)
        {
            return GetFunction<NativeDefragCachesUt>(Functions.DefragCaches140)(ObjectAddress, uAppId, ref pError);
        }

        public int IsFileNeededByApp(uint uAppId, string cszFileName, uint uFileSize, ref uint puCacheId,
            ref SteamError pError)
        {
            return GetFunction<NativeIsFileNeededByAppUsuut>(Functions.IsFileNeededByApp141)(ObjectAddress, uAppId,
                cszFileName, uFileSize, ref puCacheId, ref pError);
        }

        public uint WaitForAppResources(uint uAppId, string cszMasterList, ref SteamError pError)
        {
            return GetFunction<NativeWaitForAppResourcesUst>(Functions.WaitForAppResources142)(ObjectAddress, uAppId,
                cszMasterList, ref pError);
        }

        public int ForceCellId(uint uCellId, ref SteamError pError)
        {
            return GetFunction<NativeForceCellIdUt>(Functions.ForceCellId143)(ObjectAddress, uCellId, ref pError);
        }

        public int GetAppDlcStatus(uint uAppId, uint uDlcCacheId, ref int pbDownloaded, ref SteamError pError)
        {
            return GetFunction<NativeGetAppDlcStatusUuit>(Functions.GetAppDLCStatus144)(ObjectAddress, uAppId,
                uDlcCacheId, ref pbDownloaded, ref pError);
        }

        public int StartEngineEx(ref SteamError pError, bool bStartOffline, bool bDetectOnlineOfflineState)
        {
            return GetFunction<NativeStartEngineExTbb>(Functions.StartEngineEx145)(ObjectAddress, ref pError,
                bStartOffline, bDetectOnlineOfflineState);
        }

        public int IsUsingSdkContentServer(ref int pbUsingSdkCs, ref SteamError pError)
        {
            return GetFunction<NativeIsUsingSdkContentServerIt>(Functions.IsUsingSdkContentServer146)(ObjectAddress,
                ref pbUsingSdkCs, ref pError);
        }

        public int GetDepotParent(uint uDepotId, ref uint puParentId, ref SteamError pError)
        {
            return GetFunction<NativeGetDepotParentUut>(Functions.GetDepotParent147)(ObjectAddress, uDepotId,
                ref puParentId, ref pError);
        }

        public int GetCurrentCellId(ref uint puCellId, ref uint puPing, ref SteamError pError)
        {
            return GetFunction<NativeGetCurrentCellIduut>(Functions.GetCurrentCellID148)(ObjectAddress, ref puCellId,
                ref puPing, ref pError);
        }

        public int ForceProcessLocalEngine()
        {
            return GetFunction<NativeForceProcessLocalEngine>(Functions.ForceProcessLocalEngine149)(ObjectAddress);
        }

        public uint SetUser2(string cszUser, ref SteamError pError)
        {
            return GetFunction<NativeSetUser2St>(Functions.SetUser2150)(ObjectAddress, cszUser, ref pError);
        }
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate uint NativeOpenFileExSsiuit(
            IntPtr thisptr, string cszFileName, string cszMode, int nFlags, ref uint puFileSize, ref int pnLocal,
            ref SteamError pError);
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate uint NativeRefreshAccountInfoIt(
            IntPtr thisptr, int bContentDescriptionOnly, ref SteamError pError);
        ...
        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate int NativeGetLocalClientVersionUut(
            IntPtr thisptr, ref uint puBootStrapperVersionNum, ref uint puClientAppVersionNum, ref SteamError pError);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate int NativeIsFileNeededByCacheUsut(
            IntPtr thisptr, uint uCacheId, string cszFileName, uint uFileSize, ref SteamError pError);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate int NativeLoadFileToCacheUsbuut(
            IntPtr thisptr, uint uCacheId, string pchFileName, byte[] pubDataChunk, uint cubDataChunk,
            uint cubDataOffset, ref SteamError pError);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate int NativeGetCacheDecryptionKeyUsuut(
            IntPtr thisptr, uint uAppId, StringBuilder szCacheDecryptionKey, uint uBufferLength,
            ref uint puRecievedLength, ref SteamError pError);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate int NativeGetSubscriptionExtendedInfoUssuut(
            IntPtr thisptr, uint uSubscriptionId, string cszKeyName, StringBuilder szKeyValue, uint uBufferLength,
            ref uint puRecievedLength, ref SteamError pError);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate int NativeGetSubscriptionPurchaseCountryUsuit(
            IntPtr thisptr, uint uSubscriptionId, StringBuilder szCountry, uint uBufSize, ref int pPurchaseTime,
            ref SteamError pError);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate int NativeGetAppUserDefinedRecordUibt(
            IntPtr thisptr, uint uAppId, ref IntPtr addEntryToKeyValueFunc, byte[] pvCKeyValue, ref SteamError pError);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate int NativeFindServersNumServersE(IntPtr thisptr, ESteamServerType eSteamServerType);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate int NativeFindServersIterateServerEusi(
            IntPtr thisptr, ESteamServerType eSteamServerType, uint uIndex, StringBuilder szServerAddress,
            int iServerAddressChars);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate IntPtr NativeFindServersGetErrorString(IntPtr thisptr);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate int NativeCheckAppOwnershipUitt(
            IntPtr thisptr, uint uAppId, ref int pbOwned, ref SteamGlobalUserId pSteamGlobalUserId,
            ref SteamError pError);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate uint NativeGetCachePercentFragmentationUut(
            IntPtr thisptr, uint uAppId, ref uint puPercentFragmented, ref SteamError pError);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate uint NativeDefragCachesUt(IntPtr thisptr, uint uAppId, ref SteamError pError);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate int NativeIsFileNeededByAppUsuut(
            IntPtr thisptr, uint uAppId, string cszFileName, uint uFileSize, ref uint puCacheId, ref SteamError pError);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate uint NativeWaitForAppResourcesUst(
            IntPtr thisptr, uint uAppId, string cszMasterList, ref SteamError pError);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate int NativeForceCellIdUt(IntPtr thisptr, uint uCellId, ref SteamError pError);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate int NativeGetAppDlcStatusUuit(
            IntPtr thisptr, uint uAppId, uint uDlcCacheId, ref int pbDownloaded, ref SteamError pError);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate int NativeStartEngineExTbb(
            IntPtr thisptr, ref SteamError pError, [MarshalAs(UnmanagedType.I1)] bool bStartOffline,
            [MarshalAs(UnmanagedType.I1)] bool bDetectOnlineOfflineState);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate int NativeIsUsingSdkContentServerIt(
            IntPtr thisptr, ref int pbUsingSdkCs, ref SteamError pError);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate int NativeGetDepotParentUut(
            IntPtr thisptr, uint uDepotId, ref uint puParentId, ref SteamError pError);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate int NativeGetCurrentCellIduut(
            IntPtr thisptr, ref uint puCellId, ref uint puPing, ref SteamError pError);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate int NativeForceProcessLocalEngine(IntPtr thisptr);

        [UnmanagedFunctionPointer(CallingConvention.ThisCall)]
        private delegate uint NativeSetUser2St(IntPtr thisptr, string cszUser, ref SteamError pError);
    };
}