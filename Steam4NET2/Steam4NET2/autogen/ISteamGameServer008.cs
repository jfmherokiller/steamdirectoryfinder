...
namespace Steam4Net
{
    ...
    public class SteamGameServer008VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("SteamGameServer008")]
    public class SteamGameServer008 : InteropHelp.NativeWrapper<SteamGameServer008VTable>
    {
        public void LogOn()
        {
