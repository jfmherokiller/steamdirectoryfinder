...
namespace Steam4Net
{
    ...
    public class SteamGameServer007VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("SteamGameServer007")]
    public class SteamGameServer007 : InteropHelp.NativeWrapper<SteamGameServer007VTable>
    {
        public void LogOn()
        {
