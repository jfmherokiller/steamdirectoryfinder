...
namespace Steam4Net
{
    ...
    public class SteamNetworking005VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("SteamNetworking005")]
    public class SteamNetworking005 : InteropHelp.NativeWrapper<SteamNetworking005VTable>
    {
