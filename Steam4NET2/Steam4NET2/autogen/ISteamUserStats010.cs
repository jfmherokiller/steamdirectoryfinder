...
namespace Steam4Net
{
    ...
    public class SteamUserStats010VTable
    {
    ...
    [InteropHelp.InterfaceVersionAttribute("STEAMUSERSTATS_INTERFACE_VERSION010")]
    public class SteamUserStats010 : InteropHelp.NativeWrapper<SteamUserStats010VTable>
    {
        ...
        {
            return
                GetFunction<NativeRequestGlobalAchievementPercentages>(Functions.RequestGlobalAchievementPercentages32)(
                    ObjectAddress);
        }
        ...
        {
            return
                GetFunction<NativeGetMostAchievedAchievementInfoSufb>(Functions.GetMostAchievedAchievementInfo33)(
            ...
            ref bool pbAchieved)
        {
            return
                GetFunction<NativeGetNextMostAchievedAchievementInfoIsufb>(
                    Functions.GetNextMostAchievedAchievementInfo34)(ObjectAddress, iIteratorPrevious, pchName,
        ...
        {
            return
                GetFunction<NativeGetAchievementAchievedPercentSf>(Functions.GetAchievementAchievedPercent35)(
                    ObjectAddress, pchName, ref pflPercent);
        }

        public ulong RequestGlobalStats(int nHistoryDays)
        {
            return GetFunction<NativeRequestGlobalStatsI>(Functions.RequestGlobalStats36)(ObjectAddress, nHistoryDays);
        }

        public bool GetGlobalStat(string pchStatName, ref double pData)
        {
            return GetFunction<NativeGetGlobalStatSd>(Functions.GetGlobalStat37)(ObjectAddress, pchStatName, ref pData);
        }

        public bool GetGlobalStat(string pchStatName, ref long pData)
        {
            return GetFunction<NativeGetGlobalStatSi>(Functions.GetGlobalStat38)(ObjectAddress, pchStatName, ref pData);
        }

        public int GetGlobalStatHistory(string pchStatName, ref double pData, uint cubData)
        {
            return GetFunction<NativeGetGlobalStatHistorySdu>(Functions.GetGlobalStatHistory39)(ObjectAddress,
                pchStatName, ref pData, cubData);
        }

        public int GetGlobalStatHistory(string pchStatName, ref long pData, uint cubData)
        {
            return GetFunction<NativeGetGlobalStatHistorySiu>(Functions.GetGlobalStatHistory40)(ObjectAddress,
                pchStatName, ref pData, cubData);
        }
